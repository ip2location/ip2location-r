...
myst_html_meta = {
    "description": "IP2Location R library that enables user to get the geolocation information from IP2Location BIN database.",
    "keywords": "IP2Location, Geolocation, IP location, R",
...
html_title = "IP2Location R"

html_baseurl = "https://ip2location-r.readthedocs.io/en/latest/"